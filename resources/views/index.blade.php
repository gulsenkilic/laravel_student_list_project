...
<body>
<?php setcookie("deneme",$student->currentPage(), time() + 60000);?>
<div class="container" >
    <div> 
    <table class="table">
    <thead>
    ...
    <tr>
             ...
             <!-- <td><a href="{{ route('ogrenciguncelle2', ['sid'=>$student2->sid]) }}"class='btn btn-sm btn-primary'>DENEME</a></td> -->
             <!-- <td><a href="{{ route('ogrenciekle2') }}"class='btn btn-sm btn-primary'>ekle</a></td> -->
    </tr>
    @endforeach
    </tbody>
    </thead>
    ...
    {!! $student->appends(\Request::except('page'))->render() !!}
   ...
   <!--  <div  align="center"> 
    ...
    <tr><td>AD</td><td><input name="fname" id="fname" type=text value="{{ isset($ogrenci) ?  $ogrenci->fname:''}}" required></td></tr>
    <tr><td>SOYAD</td><td><input name="lname" name="lname" type=text value="{{ isset($ogrenci) ?  $ogrenci->lname:''}}" required></td></tr>
    <tr><td>DOĞUM YERİ</td><td><input name="birthplace" id="birthplace" value="{{ isset($ogrenci) ?  $ogrenci->birthplace:''}}" type=text  required></td></tr>
    <tr><td>DOĞUM TARİHİ</td><td><input name="birthdate" id="birthdate" value="{{ isset($ogrenci) ?  $ogrenci->birthdate:''}}" type=date  required></td></tr>
